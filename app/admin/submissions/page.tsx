...
export default function SubmissionsConsolePage() {
  ...
  return (
    <>
      {/* Top Navigation */}
      <nav className="fixed top-0 left-0 w-full flex justify-between items-center px-8 h-16 z-50 bg-white/60 backdrop-blur-md shadow-[0_40px_40px_-10px_rgba(27,27,27,0.04)]">
        <div className="flex items-center gap-8">
          ...
          <div className="hidden md:flex gap-6">
            ...
            <a className="text-red-800 font-bold border-b-2 border-red-800 pb-1 text-sm" href="#">Submissions</a>
        ...
        <div className="flex items-center gap-4">
          <button className="p-2 text-zinc-600 hover:bg-zinc-100/50 rounded-full transition-all">
      ...
      {/* Sidebar */}
      <aside className="hidden lg:flex flex-col h-screen w-64 fixed left-0 top-16 bg-zinc-50 border-r border-zinc-100 z-40">
        <div className="p-6">
          <div className="flex items-center gap-3 mb-8">
            <div className="w-10 h-10 rounded-lg bg-red-900 flex items-center justify-center text-white">
          ...
          <nav className="space-y-1">
            <a className="flex items-center gap-3 bg-white text-red-800 font-bold rounded-lg shadow-sm px-4 py-3 hover:translate-x-1 transition-transform text-sm" href="#">
              <span className="material-symbols-outlined">list_alt</span> All Submissions
            </a>
            <a className="flex items-center gap-3 text-zinc-600 hover:text-red-700 hover:bg-red-50 px-4 py-3 rounded-lg transition-all hover:translate-x-1 text-sm" href="#">
              <span className="material-symbols-outlined">pending_actions</span> Pending Review
            </a>
            <a className="flex items-center gap-3 text-zinc-600 hover:text-red-700 hover:bg-red-50 px-4 py-3 rounded-lg transition-all hover:translate-x-1 text-sm" href="#">
              <span className="material-symbols-outlined">check_circle</span> Approved
            </a>
            <a className="flex items-center gap-3 text-zinc-600 hover:text-red-700 hover:bg-red-50 px-4 py-3 rounded-lg transition-all hover:translate-x-1 text-sm" href="#">
              <span className="material-symbols-outlined">report_problem</span> Flagged
            </a>
            <a className="flex items-center gap-3 text-zinc-600 hover:text-red-700 hover:bg-red-50 px-4 py-3 rounded-lg transition-all hover:translate-x-1 text-sm" href="#">
              <span className="material-symbols-outlined">archive</span> Archived
            </a>
          </nav>
          <div className="mt-12">
        ...
        <div className="mt-auto p-6 border-t border-zinc-200/50">
          <a className="flex items-center gap-3 text-zinc-600 hover:text-red-700 px-4 py-3 rounded-lg transition-all text-sm" href="#">
            <span className="material-symbols-outlined">contact_support</span> Help Center
          </a>
        </div>
      </aside>
      ...
      <main className="lg:ml-64 pt-24 px-8 pb-12 min-h-screen">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <div className="flex gap-4">
              ...
              <div className="px-6 py-4 bg-white rounded-xl border border-zinc-100 shadow-sm flex flex-col items-center min-w-[120px]">
                ...
                <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mt-1">Pending</span>
              </div>
              <div className="px-6 py-4 bg-white rounded-xl border border-zinc-100 shadow-sm flex flex-col items-center min-w-[120px]">
                <span className="text-3xl font-headline font-extrabold text-green-700">42</span>
                <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mt-1">Approved</span>
              </div>
            </div>
          </div>
        </header>
        ...
        {/* Filters */}
        <section className="mb-8 p-6 bg-surface-container-low rounded-2xl flex flex-col xl:flex-row items-center gap-6">
          ...
          <div className="flex flex-wrap items-center gap-4 w-full">
            <div className="flex items-center gap-2">
              <label className="text-xs font-bold text-zinc-500 uppercase tracking-tighter">Milestone:</label>
              <select className="bg-white border border-zinc-200 rounded-lg text-sm px-4 py-2 focus:outline-none focus:ring-2 focus:ring-red-800/20 cursor-pointer">
            ...
            <div className="flex items-center gap-2">
              <label className="text-xs font-bold text-zinc-500 uppercase tracking-tighter">Track:</label>
              <select className="bg-white border border-zinc-200 rounded-lg text-sm px-4 py-2 focus:outline-none focus:ring-2 focus:ring-red-800/20 cursor-pointer">
            ...
            <div className="flex items-center gap-2">
              <label className="text-xs font-bold text-zinc-500 uppercase tracking-tighter">Status:</label>
              <select className="bg-white border border-zinc-200 rounded-lg text-sm px-4 py-2 focus:outline-none focus:ring-2 focus:ring-red-800/20 cursor-pointer">
            ...
            <button className="ml-auto flex items-center gap-2 text-red-800 font-bold text-sm hover:underline">
              <span className="material-symbols-outlined text-sm">filter_list</span> Clear All
            </button>
          </div>
        </section>

        {/* Table */}
        <section className="bg-white rounded-3xl overflow-hidden shadow-[0_40px_40px_-10px_rgba(27,27,27,0.04)] border border-zinc-100">
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-surface-container-low/50">
                  <th className="py-5 px-8 text-[10px] font-black text-zinc-400 uppercase tracking-widest">Student</th>
                  <th className="py-5 px-6 text-[10px] font-black text-zinc-400 uppercase tracking-widest">Milestone</th>
                  <th className="py-5 px-6 text-[10px] font-black text-zinc-400 uppercase tracking-widest">Track</th>
                  <th className="py-5 px-6 text-[10px] font-black text-zinc-400 uppercase tracking-widest">Submitted</th>
              ...
              <tbody className="divide-y divide-zinc-100">
               {loading ? (
  <tr><td colSpan={6} className="py-12 text-center text-zinc-400 text-sm">Loading submissions...</td></tr>
) : submissions.length === 0 ? (
  <tr><td colSpan={6} className="py-12 text-center text-zinc-400 text-sm">No submissions found.</td></tr>
) : submissions.map((s, i) => (
  <tr key={s.id} className="hover:bg-surface-bright transition-colors group">
    <td className="py-5 px-8">
      <div className="flex items-center gap-4">
        <div className={`w-10 h-10 rounded-full ${avatarColors[i % avatarColors.length]} flex items-center justify-center font-bold text-sm flex-shrink-0`}>
          {getInitials(s.student?.full_name ?? '?')}
        </div>
        <div>
          <p className="font-bold text-zinc-900 text-sm">{s.student?.full_name ?? 'Unknown'}</p>
          <p className="text-xs text-zinc-400">ID: {s.id.slice(0, 8)}</p>
        </div>
      </div>
    </td>
    ...
    <td className="py-5 px-8 text-right">
      ...
      <a href={`/admin/review?id=${s.id}`} className="text-sm font-bold text-red-800 hover:text-red-900">View Details</a>
          ...
          <div className="p-8 flex items-center justify-between border-t border-zinc-100">
            <p className="text-sm text-zinc-400 font-medium">Showing <span className="text-zinc-900">1–10</span> of <span className="text-zinc-900">124</span> submissions</p>
            <div className="flex items-center gap-2">
              <button className="p-2 border border-zinc-100 rounded-lg hover:bg-zinc-50 transition-colors">
                <span className="material-symbols-outlined">chevron_left</span>
              </button>
              <div className="flex items-center gap-1">
                <button className="w-10 h-10 flex items-center justify-center rounded-lg bg-red-800 text-white font-bold text-sm">1</button>
                <button className="w-10 h-10 flex items-center justify-center rounded-lg hover:bg-zinc-100 font-medium text-zinc-600 text-sm">2</button>
                <button className="w-10 h-10 flex items-center justify-center rounded-lg hover:bg-zinc-100 font-medium text-zinc-600 text-sm">3</button>
                <span className="mx-2 text-zinc-300">...</span>
                <button className="w-10 h-10 flex items-center justify-center rounded-lg hover:bg-zinc-100 font-medium text-zinc-600 text-sm">13</button>
              </div>
              <button className="p-2 border border-zinc-100 rounded-lg hover:bg-zinc-50 transition-colors">
        ...
        <section className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="p-8 rounded-3xl bg-zinc-900 text-white relative overflow-hidden group">
            ...
            <div className="absolute -right-12 -bottom-12 w-64 h-64 bg-red-900/20 rounded-full blur-3xl group-hover:bg-red-900/30 transition-all"></div>
          </div>
      ...
      <button className="fixed bottom-8 right-8 w-16 h-16 rounded-full signature-gradient text-white shadow-2xl flex items-center justify-center hover:scale-110 transition-transform z-50">
