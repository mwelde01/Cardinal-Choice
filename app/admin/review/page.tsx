...
function SubmissionReviewContent() {
  ...
  useEffect(() => {
    document.title = 'Review Submission — Cardinal Choice'
    ...
    <>
      ...
      <header className="fixed top-0 w-full flex justify-between items-center px-8 h-16 bg-white/60 backdrop-blur-md z-50 shadow-[0_40px_40px_-10px_rgba(27,27,27,0.04)]">
        ...
        <div className="flex items-center gap-4">
          ...
          <button aria-label="Help and resources" className="p-2 hover:bg-zinc-100 rounded-md transition-all">
            <span className="material-symbols-outlined text-zinc-600" aria-hidden="true">help_outline</span>
          </button>
      ...
      <aside aria-label="Review portal navigation" className="fixed left-0 top-16 h-[calc(100vh-4rem)] w-64 flex flex-col p-4 gap-2 bg-zinc-50 border-r border-zinc-100 z-40">
        ...
        <nav aria-label="Admin sidebar navigation" className="flex-1 flex flex-col gap-1">
          <a className="flex items-center gap-3 px-3 py-2 text-zinc-600 hover:bg-zinc-200/50 rounded-lg transition-transform duration-200 hover:translate-x-1 text-xs" href="/admin/submissions">
            <span className="material-symbols-outlined text-[20px]" aria-hidden="true">folder_shared</span> All Submissions
          </a>
          <a className="flex items-center gap-3 px-3 py-2 bg-white text-red-700 font-bold shadow-sm rounded-lg transition-transform duration-200 hover:translate-x-1 text-xs" href="#" aria-current="page">
            <span className="material-symbols-outlined text-[20px]" aria-hidden="true">pending_actions</span> Pending Review
          </a>
          <a className="flex items-center gap-3 px-3 py-2 text-zinc-600 hover:bg-zinc-200/50 rounded-lg transition-transform duration-200 hover:translate-x-1 text-xs" href="#">
            <span className="material-symbols-outlined text-[20px]" aria-hidden="true">task_alt</span> Approved
          </a>
          <a className="flex items-center gap-3 px-3 py-2 text-zinc-600 hover:bg-zinc-200/50 rounded-lg transition-transform duration-200 hover:translate-x-1 text-xs" href="#">
            <span className="material-symbols-outlined text-[20px]" aria-hidden="true">report_problem</span> Flagged
          </a>
          <a className="flex items-center gap-3 px-3 py-2 text-zinc-600 hover:bg-zinc-200/50 rounded-lg transition-transform duration-200 hover:translate-x-1 text-xs" href="#">
            <span className="material-symbols-outlined text-[20px]" aria-hidden="true">inventory_2</span> Archive
          </a>
        </nav>
        ...
        <div className="mt-auto flex flex-col gap-1 border-t border-zinc-200 pt-4">
          <a className="flex items-center gap-3 px-3 py-2 text-zinc-500 text-xs hover:text-zinc-800 transition-colors" href="#">
            <span className="material-symbols-outlined text-[18px]" aria-hidden="true">dns</span> System Status
          </a>
          <a className="flex items-center gap-3 px-3 py-2 text-zinc-500 text-xs hover:text-zinc-800 transition-colors" href="#">
            <span className="material-symbols-outlined text-[18px]" aria-hidden="true">contact_support</span> Support
          </a>
        </div>
      </aside>

      {/* Main Content */}
      <main id="main-content" className="ml-64 pt-16 min-h-screen bg-surface flex flex-col">
          ...
          <div className="max-w-7xl mx-auto flex justify-between items-end">
            <div>
              <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-xs text-zinc-500 mb-4">
                ...
                <span className="text-zinc-500" aria-current="page">Reviewing Submission</span>
              </nav>
              ...
              <div className="flex items-center gap-4 flex-wrap">
                <span className="bg-primary-fixed text-on-primary-fixed px-2 py-0.5 rounded text-xs font-bold tracking-wider uppercase">
                ...
                <span className="text-sm text-zinc-600 flex items-center gap-1.5">
                  <span className="material-symbols-outlined text-[18px]" aria-hidden="true">fingerprint</span> ID: 2994-MT
                </span>
                <span className="text-sm text-zinc-600 flex items-center gap-1.5">
                  <span className="material-symbols-outlined text-[18px]" aria-hidden="true">school</span> Milestone 1: Executive Summary
                </span>
              </div>
            </div>
            <div className="flex flex-col items-end">
              <span className="text-xs font-bold text-zinc-500 uppercase tracking-widest mb-1">Academic Track</span>
        ...
        <section className="flex-1 flex max-w-7xl mx-auto w-full gap-12 px-12 py-12">
          ...
          <div className="w-2/3 flex flex-col gap-6">
            <div className="flex items-center justify-between">
              <h2 className="text-xl font-bold font-headline text-zinc-900">Submission Document</h2>
              <button aria-label="Open document in full view" className="flex items-center gap-1 text-sm text-zinc-500 hover:text-zinc-800 transition-colors">
                <span className="material-symbols-outlined" aria-hidden="true">open_in_full</span> Open full view
              </button>
            </div>

            {/* PDF Placeholder */}
            <div className="bg-zinc-100 rounded-xl overflow-hidden min-h-[800px] relative shadow-sm border border-black/[0.03]" aria-label="Document preview" role="img">
              <div className="absolute inset-0 p-16 flex flex-col">
                <div className="w-full h-full bg-white shadow-lg p-12 flex flex-col gap-8">
                  ...
                  <div className="mt-8 rounded-lg overflow-hidden border border-zinc-100 bg-zinc-50 h-48 flex items-center justify-center" aria-hidden="true">
                    <span className="material-symbols-outlined text-zinc-300 text-6xl" aria-hidden="true">insert_chart</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="w-1/3 flex flex-col gap-8">
            ...
            <div className="p-6 bg-surface-container-high rounded-xl border-l-4 border-tertiary">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="font-bold font-headline text-sm text-zinc-800">Reviewing Milestones</h3>
              </div>
              ...
              <a className="text-xs font-bold text-tertiary-container hover:underline flex items-center gap-1" href="#">
                Review Guidelines <span className="material-symbols-outlined text-xs" aria-hidden="true">arrow_outward</span>
              </a>
            </div>
            ...
            <div className="bg-surface-container-low p-8 rounded-xl flex flex-col gap-8">
              <div>
                <h3 className="text-lg font-bold font-headline text-zinc-900 mb-6">Academic Rubric</h3>
              ...
              <div className="flex flex-col gap-3">
                <label htmlFor="reviewer-feedback" className="text-xs font-black uppercase tracking-widest text-zinc-500">Reviewer Feedback</label>
                <textarea
              ...
              <div className="flex flex-col gap-3 pt-4">
                ...
                <button className="w-full py-3 text-error font-bold text-xs flex items-center justify-center gap-2 hover:bg-error-container/20 rounded-lg transition-colors">
                  <span className="material-symbols-outlined text-[18px]" aria-hidden="true">flag</span> Flag for Review
                </button>
              </div>
            </div>
            ...
            {/* File Details */}
            <div className="px-2">
              <p className="text-xs font-bold text-zinc-500 uppercase tracking-widest mb-4">File Details</p>
              <div className="flex flex-wrap gap-2">
                <div className="flex items-center gap-2 px-3 py-1.5 bg-primary-fixed rounded-full">
                  <span className="material-symbols-outlined text-[16px] text-on-primary-fixed" aria-hidden="true">description</span>
                  <span className="text-xs font-bold text-on-primary-fixed uppercase tracking-tight">PDF Document</span>
                </div>
                <div className="flex items-center gap-2 px-3 py-1.5 bg-tertiary-fixed rounded-full">
                  <span className="material-symbols-outlined text-[16px] text-on-tertiary-fixed" aria-hidden="true">analytics</span>
                  <span className="text-xs font-bold text-on-tertiary-fixed uppercase tracking-tight">Financial Model</span>
                </div>
              </div>
            </div>
          </div>
