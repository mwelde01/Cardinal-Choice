...
export default function UploadsPage() {
  ...
  return (
    <>
        ...
        <div className="flex justify-between items-center w-full px-8 py-4 max-w-screen-2xl mx-auto">
          <div className="flex items-center gap-12">
            ...
            <div className="hidden md:flex gap-8 items-center">
              ...
              <a className="text-red-800 border-b-2 border-red-800 pb-1 font-headline tracking-tight text-sm font-semibold" href="#">Materials</a>
          ...
          <div className="flex items-center gap-4">
            <button className="p-2 text-zinc-500 hover:bg-zinc-100/50 rounded-md transition-all">
      ...
      {/* Main Content */}
      <main className="pt-24 pb-16 px-8 max-w-screen-2xl mx-auto flex flex-col gap-12">
          ...
          <div className="lg:col-span-8 space-y-10">
            ...
            <section>
              <div className="flex items-center gap-3 mb-6">
                <span className="h-8 w-8 rounded-lg bg-primary text-white flex items-center justify-center font-bold text-sm">3</span>
                <h2 className="font-headline text-2xl font-bold">Complete Milestones</h2>
              </div>
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                ...
                <div className="p-4 flex flex-col items-center justify-center">
                  <p className="text-[10px] text-on-surface-variant/60 text-center italic leading-tight">MBA 621 & 623 are exempt</p>
                </div>
              </div>
            </section>
            ...
            <section className="border-t border-outline/10 pt-10">
              <div className="flex items-center gap-3 mb-6">
                <span className="h-8 w-8 rounded-lg bg-primary text-white flex items-center justify-center font-bold text-sm">4</span>
                <h2 className="font-headline text-2xl font-bold">Produce Final Deliverable</h2>
              </div>
              <div className="bg-surface-container-low rounded-xl p-8 border border-primary/20 ghost-shadow">
                <div className="mb-8">
                  <label className="text-xs font-bold text-on-surface-variant uppercase tracking-widest mb-4 block">Select Your Path</label>
                ...
                <div className="space-y-4">
                  ...
                  <label className="group flex flex-col items-center justify-center w-full h-48 bg-white hover:bg-surface-bright transition-all cursor-pointer rounded-xl border-2 border-dashed border-primary/20 overflow-hidden">
                    <span className="material-symbols-outlined text-4xl text-primary mb-3 opacity-40 group-hover:scale-110 transition-transform">file_upload</span>
                    <p className="text-sm font-semibold">Drop Final Deliverable here</p>
                    <p className="text-[10px] text-on-surface-variant mt-1 uppercase tracking-tighter font-bold">Required for core completion</p>
                    <input type="file" className="hidden" />
                  </label>
                </div>
              </div>
            ...
            <section className="space-y-6">
              <div className="flex justify-between items-end">
                <h2 className="font-headline text-3xl font-bold">Recent Uploads</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                {recentUploads.map((r) => (
                  <div key={r.code} className="group bg-white p-5 rounded-xl ghost-shadow border border-outline-variant/10 hover:ring-2 ring-primary/20 transition-all cursor-pointer">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-on-surface-variant uppercase font-bold tracking-tight">{r.semester}</p>
                      </div>
                    </div>
                    <p className="text-[11px] text-on-surface-variant line-clamp-2 italic mb-3">&ldquo;{r.description}&rdquo;</p>
                    <div className="flex items-center gap-2">
                      <span className="material-symbols-outlined text-xs text-green-600" style={{ fontVariationSettings: "'FILL' 1" }}>check_circle</span>
                      <span className="text-[10px] font-bold text-green-600">SUBMITTED</span>
                    </div>
                  </div>
                ))}
                <div className="bg-surface-container-low border-2 border-dashed border-outline/10 p-5 rounded-xl flex flex-col items-center justify-center gap-2 opacity-60">
                  <span className="material-symbols-outlined text-3xl">pending</span>
                  <p className="text-[10px] font-bold uppercase tracking-widest text-on-surface-variant">Next: MBA 628</p>
                </div>
              </div>
            </section>
          </div>
              ...
              <div className="bg-white rounded-xl p-6 ghost-shadow border border-outline-variant/10">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3 mt-6 p-4 bg-tertiary-fixed/30 rounded-lg">
                    ...
                    <p className="text-[11px] text-on-tertiary-fixed font-medium leading-tight">
              ...
              <div className="bg-surface-container-low rounded-xl p-6 space-y-6">
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest block">Display Title</label>
                    <input
                      type="text"
                      value={title}
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest block">Artifact Category</label>
                    <div className="flex flex-wrap gap-2">
                      {categories.map((cat) => (
                        <button
                          key={cat}
                          onClick={() => setSelectedCategory(cat)}
                          className={`px-3 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-tight transition-all ${
      ...
      <div className="fixed bottom-8 right-8">
        <button className="bg-on-surface text-white h-14 w-14 rounded-full flex items-center justify-center shadow-2xl hover:scale-105 active:scale-95 transition-all">
