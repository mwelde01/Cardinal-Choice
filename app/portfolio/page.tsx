...
export default function PortfolioPage() {
  ...
  useEffect(() => {
    document.title = 'Portfolio — Cardinal Choice'
  ...
  return (
    <>
      {/* Top Navigation */}
      <nav aria-label="Primary navigation" className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md border-b border-outline">
        <div className="flex justify-between items-center w-full px-8 py-4 max-w-screen-2xl mx-auto">
          <div className="flex items-center gap-8">
            ...
            <div className="hidden md:flex items-center gap-6">
              <a className="text-zinc-500 hover:text-primary transition-colors font-headline tracking-tight text-sm font-semibold" href="/dashboard">Dashboard</a>
              <a className="text-zinc-500 hover:text-primary transition-colors font-headline tracking-tight text-sm font-semibold" href="/uploads">Materials</a>
              <a className="text-primary border-b-2 border-primary pb-1 font-headline tracking-tight text-sm font-semibold" href="/portfolio" aria-current="page">Public Portfolio</a>
            </div>
          </div>
          <div className="flex items-center gap-4">
            <button aria-label="View notifications" className="p-2 hover:bg-zinc-100 rounded-md transition-all">
      ...
      {/* Sidebar */}
      <aside aria-label="Portfolio navigation" className="hidden md:flex h-screen w-64 fixed left-0 top-0 pt-20 bg-zinc-50 border-r border-outline flex-col p-4 gap-2 z-40">
        ...
        <nav aria-label="Portfolio sidebar navigation" className="flex-1 flex flex-col gap-1">
          ...
          <a className="flex items-center gap-3 px-3 py-2 bg-white text-primary shadow-sm border border-outline rounded-lg transition-all text-sm font-bold" href="/portfolio" aria-current="page">
            <span className="material-symbols-outlined" aria-hidden="true">visibility</span> Public Preview
          </a>
          <a className="flex items-center gap-3 px-3 py-2 text-zinc-600 hover:bg-white hover:text-primary transition-all text-sm font-semibold rounded-lg" href="/sharing">
            <span className="material-symbols-outlined" aria-hidden="true">share</span> Share Link
          </a>
        </nav>
        <div className="mt-auto flex flex-col gap-1 border-t border-outline pt-4">
          ...
          <button onClick={signOut} className="flex items-center gap-3 px-3 py-2 text-zinc-600 hover:bg-zinc-100 transition-all text-sm font-medium rounded-lg w-full">
            <span className="material-symbols-outlined" aria-hidden="true">logout</span> Sign Out
          </button>
        </div>
      </aside>

      {/* Main Content */}
      <main id="main-content" className="md:ml-64 pt-20 min-h-screen">
        <div className="max-w-6xl mx-auto px-8 py-12">

          {/* Hero Section */}
          <section aria-labelledby="portfolio-hero-heading" className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-20 border-b border-outline pb-20">
            <div className="lg:col-span-8">
              <div className="flex items-center gap-3 mb-6">
                <span className="bg-[#FEBE10] px-3 py-1 rounded text-xs font-black text-[#261900] uppercase tracking-widest">Industry Track Candidate</span>
                <span className="text-zinc-300" aria-hidden="true">|</span>
                <span className="text-zinc-500 text-xs font-bold uppercase tracking-widest">Class of 2024</span>
              </div>
              <h1 id="portfolio-hero-heading" className="font-headline text-5xl md:text-7xl font-extrabold tracking-tighter text-on-background mb-6 leading-none">
              ...
              <div className="flex items-center gap-4">
                ...
                <button className="flex items-center gap-2 px-8 py-4 border-2 border-outline rounded-full font-bold text-sm hover:bg-zinc-50 transition-colors">
                  <span className="material-symbols-outlined text-sm" aria-hidden="true">mail</span> Contact Candidate
                </button>
              </div>
            </div>
            <div className="lg:col-span-4 relative">
              <div className="aspect-square bg-zinc-100 rounded-[2rem] overflow-hidden border-8 border-white shadow-2xl relative z-10 flex items-center justify-center">
                <span className="font-headline font-black text-8xl text-zinc-300" aria-hidden="true">
                  {firstName.charAt(0)}{lastName.charAt(0)}
                </span>
              </div>
              <div className="absolute -bottom-6 -right-6 h-32 w-32 bg-[#FEBE10] rounded-full flex flex-col items-center justify-center shadow-xl z-20 border-4 border-white" aria-label="100% Complete">
                <span className="font-headline font-black text-3xl text-[#261900]" aria-hidden="true">100%</span>
                <span className="text-xs font-bold uppercase text-[#261900]/70 tracking-widest" aria-hidden="true">Complete</span>
              </div>
            </div>
          </section>

          {/* Final Deliverable */}
          <section aria-labelledby="final-deliverable-heading" className="mb-24">
            <div className="bg-primary p-1 rounded-[3rem] shadow-2xl">
              <div className="bg-white rounded-[2.8rem] p-10 md:p-16 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-64 h-64 bg-[#FEBE10]/10 rounded-full -mr-32 -mt-32" aria-hidden="true"></div>
                <div className="relative z-10 flex flex-col md:flex-row gap-12 items-center">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-4">
                      <span className="material-symbols-outlined text-[#FEBE10]" style={{ fontVariationSettings: "'FILL' 1" }} aria-hidden="true">star</span>
                      <span className="text-primary font-black uppercase tracking-[0.2em] text-xs">Capstone Milestone</span>
                    </div>
                    <h2 id="final-deliverable-heading" className="font-headline text-4xl md:text-5xl font-black mb-6 leading-tight">Industry White Paper</h2>
                  ...
                  <div className="w-full md:w-1/3 aspect-[3/4] bg-zinc-50 rounded-2xl border-4 border-outline flex flex-col items-center justify-center p-8 text-center">
                    <span className="material-symbols-outlined text-6xl text-zinc-300 mb-4" aria-hidden="true">article</span>
                    <p className="text-zinc-500 font-bold text-xs uppercase tracking-widest">Final Version Published<br />March 2024</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Milestones Grid */}
          <section aria-labelledby="milestones-heading" className="mb-24">
            <div className="flex flex-col md:flex-row justify-between items-baseline mb-12 gap-4">
              <div>
                <h2 id="milestones-heading" className="font-headline text-3xl font-black text-on-background tracking-tight">Core Curriculum Milestones</h2>
                <p className="text-zinc-500 font-medium mt-1">11 verified course submissions from the Cardinal Choice MBA program.</p>
              </div>
              <div className="h-[2px] flex-1 bg-outline mx-8 hidden md:block" aria-hidden="true"></div>
              ...
              {milestones.map((m) => (
                <div key={m.code} className="bg-zinc-50 border border-outline p-6 rounded-[2rem] hover:shadow-xl hover:border-primary/20 transition-all group flex flex-col h-full">
                  <div className="flex justify-between items-start mb-6">
                    ...
                    <span className="material-symbols-outlined text-zinc-300 group-hover:text-[#FEBE10] transition-colors" style={{ fontVariationSettings: "'FILL' 1" }} aria-hidden="true">verified</span>
                  </div>
                  ...
                  <a className="flex items-center justify-between py-3 px-4 bg-white rounded-xl border border-outline group-hover:border-primary transition-colors" href="#">
                    <div className="flex items-center gap-2">
                      <span className="material-symbols-outlined text-primary text-lg" aria-hidden="true">{m.fileIcon}</span>
                      <span className="text-xs font-bold text-zinc-600">View {m.fileType}</span>
                    </div>
                    <span className="material-symbols-outlined text-zinc-300 group-hover:translate-x-1 transition-transform" aria-hidden="true">arrow_right_alt</span>
                  </a>
                </div>
              ))}
            </div>
          ...
          {/* Share & Verification */}
          <section aria-labelledby="share-heading" className="bg-white rounded-[3rem] p-12 border border-outline shadow-lg relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center relative z-10">
              <div>
                <h2 id="share-heading" className="font-headline text-3xl font-black mb-4">Official Portfolio Link</h2>
                ...
                <div className="flex items-center bg-zinc-50 border border-outline rounded-2xl p-2 pl-6">
                  <span className="text-zinc-500 text-sm truncate flex-1 font-semibold">{`cardinalchoice.edu/p/${lastName.toLowerCase()}-${firstName.toLowerCase()}-2024`}</span>
                ...
                <div className="flex items-center justify-between p-5 bg-zinc-50 border border-outline rounded-2xl">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-zinc-500 font-bold uppercase tracking-wider">Cardinal Choice Curriculum</p>
                    </div>
                  </div>
                  <span className="material-symbols-outlined text-green-500" style={{ fontVariationSettings: "'FILL' 1" }} aria-hidden="true">check_circle</span>
                </div>
                <div className="flex items-center justify-between p-5 bg-zinc-50 border border-outline rounded-2xl">
                  <div className="flex items-center gap-4">
                    <div className="h-12 w-12 rounded-xl bg-white border border-outline flex items-center justify-center text-primary shadow-sm">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-zinc-500 font-bold uppercase tracking-wider">Authentication Confirmed</p>
                    </div>
                  </div>
                  <span className="material-symbols-outlined text-green-500" style={{ fontVariationSettings: "'FILL' 1" }} aria-hidden="true">check_circle</span>
                </div>
          ...
          <footer className="mt-24 pt-12 border-t border-outline flex flex-col md:flex-row justify-between items-center gap-6 pb-12">
            <div className="flex items-center gap-2">
              ...
              <span className="text-zinc-300 h-4 w-[1px] bg-zinc-300 mx-2" aria-hidden="true"></span>
              <span className="text-zinc-500 text-xs uppercase font-black tracking-[0.2em]">Academic Portfolio v4.0</span>
            </div>
            <div className="flex gap-8">
              <a className="text-xs font-black text-zinc-500 hover:text-primary uppercase tracking-widest transition-colors" href="#">Privacy Policy</a>
              <a className="text-xs font-black text-zinc-500 hover:text-primary uppercase tracking-widest transition-colors" href="#">System Status</a>
              <a className="text-xs font-black text-zinc-500 hover:text-primary uppercase tracking-widest transition-colors" href="#">Support</a>
            </div>
          </footer>
        </div>
      </main>
