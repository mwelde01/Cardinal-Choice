...
export default function DashboardPage() {
  ...
  useEffect(() => {
    document.title = 'Dashboard — Cardinal Choice'
  ...
  return (
    <>
        ...
        <div className="flex justify-between items-center w-full px-8 py-4 max-w-screen-2xl mx-auto">
          <div className="flex items-center gap-8">
            ...
            <div className="hidden md:flex gap-6 items-center font-headline tracking-tight text-sm font-semibold">
              <a className="text-red-800 border-b-2 border-red-800 pb-1" href="#" aria-current="page">Dashboard</a>
      ...
      <aside aria-label="Workspace navigation" className="hidden lg:flex h-screen w-64 fixed left-0 top-0 flex-col p-4 gap-2 bg-zinc-50 z-40 pt-24">
        <div className="px-4 mb-6">
          ...
          <div className="space-y-1">
            <a className="flex items-center gap-3 p-3 bg-white text-red-800 shadow-sm rounded-lg font-medium text-sm transition-transform duration-200 hover:translate-x-1" href="#" aria-current="page">
          ...
          <div className="col-span-12 lg:col-span-8 space-y-12">
            ...
            <section aria-labelledby="milestone-heading">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                {submissions.map((m) => (
                  <div
                    key={m.id}
                    className={`p-4 rounded-xl border-2 flex flex-col items-center justify-between min-h-[140px] relative transition-all
                    ...
                    `}
                  >
                    <div className={`absolute top-2 right-2 flex items-center gap-1 px-1.5 py-0.5 rounded text-xs font-bold uppercase
                    ...
                    <div className="mt-4 text-center">
                      ...
                      <p className="text-xs text-zinc-500 font-medium uppercase tracking-tighter leading-tight">{m.milestone?.title}</p>
                    </div>
            ...
            <section aria-labelledby="deliverable-heading" className="bg-white rounded-3xl p-10 ghost-shadow border border-zinc-100">
              <div className="flex flex-col md:flex-row gap-12 items-start">
                <div className="flex-1 space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 gap-3" role="radiogroup" aria-label="Select final deliverable track">
                      <button className="flex items-center justify-between p-4 rounded-xl border-2 border-primary bg-primary/5 text-left transition-all" aria-pressed="true">
                        <div>
                          <p className="font-headline font-bold text-sm">Career Plan</p>
                          <p className="text-xs text-zinc-500">Career Track: Explore your current or future path</p>
                        </div>
                        <span className="material-symbols-outlined text-primary" style={{ fontVariationSettings: "'FILL' 1" }} aria-hidden="true">radio_button_checked</span>
                      </button>
                      <button className="flex items-center justify-between p-4 rounded-xl border-2 border-zinc-100 hover:border-zinc-300 text-left transition-all" aria-pressed="false">
                        <div>
                          <p className="font-headline font-bold text-sm">White Paper</p>
                          <p className="text-xs text-zinc-500">Industry Track: Look at a critical industry problem</p>
                        </div>
                        <span className="material-symbols-outlined text-zinc-300" aria-hidden="true">radio_button_unchecked</span>
                      </button>
                      <button className="flex items-center justify-between p-4 rounded-xl border-2 border-zinc-100 hover:border-zinc-300 text-left transition-all" aria-pressed="false">
                        <div>
                          <p className="font-headline font-bold text-sm">Process Improvement Plan</p>
                          <p className="text-xs text-zinc-500">Issue Track: Focus on systemic organizational issues</p>
                        </div>
                        <span className="material-symbols-outlined text-zinc-300" aria-hidden="true">radio_button_unchecked</span>
                      </button>
                    </div>
                ...
                <div className="w-full md:w-64 aspect-[3/4] bg-zinc-50 rounded-2xl flex flex-col items-center justify-center border-2 border-dashed border-zinc-200 hover:bg-zinc-100 transition-all">
      ...
      <nav aria-label="Mobile navigation" className="md:hidden fixed bottom-0 w-full bg-white border-t border-zinc-100 flex justify-around py-3 z-50">
        <a className="flex flex-col items-center gap-1 text-primary" href="#" aria-current="page">
          <span className="material-symbols-outlined" style={{ fontVariationSettings: "'FILL' 1" }} aria-hidden="true">dashboard</span>
